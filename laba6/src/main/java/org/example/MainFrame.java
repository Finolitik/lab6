...
// доступными - сделать доступным "Паузу"
        ...
        JMenu controlMenu1 = new JMenu("270");
        ...
        pauseMenuItem270 = controlMenu1.add(pausedAction270);
        pauseMenuItem270.setEnabled(true);

        Action removeAction270 = new AbstractAction("Возобновить движение 270") {
            public void actionPerformed(ActionEvent event) {
                List<BouncingBall> balls270 = new ArrayList<BouncingBall>();
                for(BouncingBall ball : field.getBalls())
                {
        ...
        pauseMenuItem270 = controlMenu1.add(removeAction270);
        pauseMenuItem270.setEnabled(true);
