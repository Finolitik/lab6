...
// и просто выходим (завершаемся)
    ...
    public void paint(Graphics2D canvas) {
        ...
        Ellipse2D.Double ball = new Ellipse2D.Double(x-radius, y-radius, 2*radius, 2*radius);        canvas.draw(ball);
        canvas.fill(ball);
    }
    ...
    public void paused270(boolean paused) {
        this.paused = paused;
    ...
    public void removed270(boolean paused) {
        this.paused = paused;
